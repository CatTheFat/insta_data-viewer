...
//List : lists the data of the messages.json file
func List() {
	var name string
	isGroup := false
...
//ExportConv : Exports a singe conversation and its contents
...
//ExportAll : exports all conversations and their contents
func ExportAll() {
	var isGroup bool
	var name string
